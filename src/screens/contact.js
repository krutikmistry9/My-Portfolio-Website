...
const ContactScreen = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm(SERVICE_ID, TEMPLATE_ID, form.current, API_KEY).then(
      ...
      (error) => {
        setLoading(false);
        setError("Could not send Email. Try again or contact me at krutik.mistry2203@gmail.com");
      }
    );
    e.target.reset();
  };
    ...
    <div>
      <div className="fourthView">
        ...
        <div className="fourthLeft">
          ...
          <h1> Contact </h1>
          <form action="https://formsubmit.co/krutik.mistry2203@gmail.com" method="POST">
